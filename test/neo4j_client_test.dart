...
void main() {
  test('Neo4jClient Request', (){
    ...
    expect(request.json, {'statements': [{'statement': 'MATCH (t:Test) RETURN t'}]});
  });
  ...
  test('Neo4jClient', () async {
    ...
    expect(headers, {'Accept': 'application/json; charset=UTF-8', 'Content-Type': 'application/json; charset=utf-8'});
    expect(response.columns, ["test"]);
    expect(response.errors, []);
    expect(response.rows, [
      { "property_1": "test_1", "property_2": "test_2", "property_3": "test_3" }, 
